...
const gastroItems = [
  {
    name: "Gastroscope",
    image: "/gastro/gastroscope.jpg",
  },
  {
    name: "Colonoscope",
    image: "/gastro/colonoscope.jpg",
  },
  {
    name: "Endoscopy Tower",
    image: "/gastro/endoscopy.jpg",
  },
  {
    name: "Biopsy Forceps",
    image: "/gastro/biopsy.jpg",
  },
  {
    name: "ERCP Device",
    image: "/gastro/ercp.jpg",
  },
  {
    name: "Polypectomy Snare",
    image: "/gastro/snare.jpg",
  },
];
    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            High-quality gastrointestinal diagnostic and treatment solutions.
          </motion.p>
        </motion.div>
      </section>
      ...
      <section className="bg-[#F8FAFC] py-5 border-b border-[#E5E7EB]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-sm md:text-base text-[#4B5563]">
            ...
            <span className="text-[#111827] font-medium">Gastroenterology</span>
          </div>
        </div>
      </section>
